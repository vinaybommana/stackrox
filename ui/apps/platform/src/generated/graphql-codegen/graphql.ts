...
export type Cluster_Summary_CountsQueryVariables = Exact<{ [key: string]: never }>;

export type Cluster_Summary_CountsQuery = { __typename?: 'Query'; clusterCount: number };
...
export type DeploymentsQuery = { __typename?: 'Query'; count: number };
...
export const Cluster_Summary_CountsDocument = {
    kind: 'Document',
    definitions: [
        {
            kind: 'OperationDefinition',
            operation: 'query',
            name: { kind: 'Name', value: 'cluster_summary_counts' },
            selectionSet: {
                kind: 'SelectionSet',
                selections: [{ kind: 'Field', name: { kind: 'Name', value: 'clusterCount' } }],
            },
        },
    ],
} as unknown as DocumentNode<Cluster_Summary_CountsQuery, Cluster_Summary_CountsQueryVariables>;
