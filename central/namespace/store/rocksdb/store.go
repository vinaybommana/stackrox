...
func (b *storeImpl) Get(id string) (*storage.NamespaceMetadata, bool, error) {
...
func (b *storeImpl) GetMany(ids []string) ([]*storage.NamespaceMetadata, []int, error) {
...
func (b *storeImpl) Upsert(obj *storage.NamespaceMetadata) error {
...
func (b *storeImpl) UpsertMany(objs []*storage.NamespaceMetadata) error {
...
func (b *storeImpl) Walk(fn func(obj *storage.NamespaceMetadata) error) error {
