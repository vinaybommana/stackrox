...
func (b *indexerImpl) AddComponentCVEEdge(componentcveedge *storage.ComponentCVEEdge) error {
	...
	if err := b.index.Index.Index(componentcveedge.GetId(), &componentCVEEdgeWrapper{
...
func (b *indexerImpl) ResetIndex() error {
	defer metrics.SetIndexOperationDurationTime(time.Now(), ops.Reset, "ComponentCVEEdge")
	return blevesearch.ResetIndex(v1.SearchCategory_COMPONENT_VULN_EDGE, b.index.Index)
}

func (b *indexerImpl) Search(q *v1.Query, opts ...blevesearch.SearchOption) ([]search.Result, error) {
	defer metrics.SetIndexOperationDurationTime(time.Now(), ops.Search, "ComponentCVEEdge")
	return blevesearch.RunSearchRequest(v1.SearchCategory_COMPONENT_VULN_EDGE, q, b.index.Index, mappings.OptionsMap, opts...)
}
