...
// Source: github.com/stackrox/rox/central/componentcveedge/datastore (interfaces: DataStore)
...
func (m *MockDataStore) Get(arg0 context.Context, arg1 string) (*storage.ComponentCVEEdge, bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockDataStore) GetBatch(arg0 context.Context, arg1 []string) ([]*storage.ComponentCVEEdge, error) {
	m.ctrl.T.Helper()
...
func (m *MockDataStore) SearchRawEdges(arg0 context.Context, arg1 *v1.Query) ([]*storage.ComponentCVEEdge, error) {
	m.ctrl.T.Helper()
...
func (m *MockDataStore) Upsert(arg0 context.Context, arg1 *storage.ComponentCVEEdge) error {
	m.ctrl.T.Helper()
