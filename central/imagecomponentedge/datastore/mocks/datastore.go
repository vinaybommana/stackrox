...
// Source: github.com/stackrox/rox/central/imagecomponentedge/datastore (interfaces: DataStore)
...
func (m *MockDataStore) Upsert(arg0 context.Context, arg1 *storage.ImageComponentEdge) error {
	m.ctrl.T.Helper()
