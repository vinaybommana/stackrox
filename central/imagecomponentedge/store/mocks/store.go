...
func (m *MockStore) GetAll() ([]*storage.ImageComponentEdge, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) Get(id string) (*storage.ImageComponentEdge, bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetBatch(ids []string) ([]*storage.ImageComponentEdge, []int, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) Upsert(cve *storage.ImageComponentEdge) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Upsert", cve)
	ret0, _ := ret[0].(error)
	return ret0
}

// Upsert indicates an expected call of Upsert
func (mr *MockStoreMockRecorder) Upsert(cve interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Upsert", reflect.TypeOf((*MockStore)(nil).Upsert), cve)
}

// UpsertBatch mocks base method
func (m *MockStore) UpsertBatch(cves []*storage.ImageComponentEdge) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpsertBatch", cves)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpsertBatch indicates an expected call of UpsertBatch
func (mr *MockStoreMockRecorder) UpsertBatch(cves interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpsertBatch", reflect.TypeOf((*MockStore)(nil).UpsertBatch), cves)
}
