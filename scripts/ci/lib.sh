...
push_matching_collector_scanner_images() {
    ...
    for target_registry in "${target_registries[@]}"; do
        ...
        _retag_or_mirror "${source_registry}/scanner:${scanner_version}"         "${target_registry}/scanner-classic:${main_tag}"
        _retag_or_mirror "${source_registry}/scanner-db:${scanner_version}"      "${target_registry}/scanner-db-classic:${main_tag}"
        _retag_or_mirror "${source_registry}/scanner-slim:${scanner_version}"    "${target_registry}/scanner-slim-classic:${main_tag}"
        _retag_or_mirror "${source_registry}/scanner-db-slim:${scanner_version}" "${target_registry}/scanner-db-slim-classic:${main_tag}"
